    ...
    <table id="table_bug_report" class="table table-striped table-bordered table-hover">
      ...
      <tbody>
        ...
        <tr>
          <td>${brand.bCName}</td>
          <td>${brand.bName}</td>
          <td>${brand.reportType}</td>
          <td>${brand.reportUrl}</td>
          <td>
 ...
 <table id="table_bug_report" class="table table-striped table-bordered table-hover">
  ...
  <!--      <th class="center">
      ...
      <tbody>
        ...
        <c:forEach items="${brandinflist}" var="brandinformation">
        <tr>
           <td>${brandinformation.brandInforID}</td>
           <td>${brandinformation.brandName}</td><br/>
           <td><img src="${brandinformation.brandLogo}"  width="160" alt="" /></td>
    <!--       
          <th class="center">
...
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal2">查询所有品牌信息</button>
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal">新增</button>
<button class="btn btn-primary" data-toggle="modal" data-target="#myModal1">删除</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" >
          <form class="form-horizontal" action="addBrand.action"  method="post" enctype="multipart/form-data">
              
               <div class="control-group">
              <label class="control-label" for="form-field-1">品牌ID<br>Brand Id</label>
              <div class="controls">
                <input type="text" id="form-field-1" name="brandInforID" >
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="brandName" >
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                  ...
                  <div>
                   ...
                   <button type="submit" id="ctlBtn" class="btn btn-default">开始上传</button>
                  </div>
                  </div>
                  </span>
                </div>
...
<div class="modal fade" id="myModal1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" >
          <form class="form-horizontal" action="deleteBrand.action"  method="post" enctype="multipart/form-data">
        ...
        <div class="modal-footer">
        <button type="reset" class="btn btn-default" data-dismiss="modal">取消</button>
        <button type="submit" id="ctlBtn" class="btn btn-default" onclick="submittr()">确认删除</button>
      </div>
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" >
          <form class="form-horizontal" action="selectAll.action"  method="post" enctype="multipart/form-data">
            
        <div class="modal-footer">
        <button type="reset" class="btn btn-default" data-dismiss="modal">取消</button>
        <button type="submit" id="ctlBtn" class="btn btn-default">确认查询</button>
      </div>
   ...
   uploader.on( 'uploadComplete', function( file ) {
    ...
    function goEdit(){
        window.location.href = "brand-addbrand.jsp";
      }
    </script>
