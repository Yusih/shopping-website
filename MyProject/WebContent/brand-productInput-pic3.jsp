    ...
    <div id="main-content" class="clearfix">
      <div id="page-content" class="clearfix">
        <div class="page-header position-relative">
          <h1 style="color: #2679b5;">品牌商<small><i class="icon-double-angle-right"></i> 商品信息图片修改</small></h1>
        </div>

          <form class="form-horizontal" action="updateProduct.action" enctype="multipart/form-data" method="post">
           <div class="control-group">
              <p class="red">商品标题准确、简洁、完整</p>
              <label class="control-label" for="form-field-1">商品标题</label>
              <div class="controls">
                <input type="text" name="proName" value="${product.proName}" readonly/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
				<input type="text" id="type" name="proType" value="${product.proType}"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <label class="control-label" for="form-field-1">商品主图</label>
				<br>
              <div class="controls">
                  	选择图片：<input type="file" name="proPic" value="${product.proPic}"/>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                体积Volume  <input class="input-mini" type="text" id="form-field-4-5" onkeyup="jisuan();" name="volume" value="${product.volume}">立方厘米        
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="sku" value="${product.sku}">
              </div>
            </div>
            ...
            <div class="controls">
              <input type="text" id="form-field-1" name="upc" value="${product.upc}">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="ena" value="${product.ena}">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="price" value="${product.price}">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="stock" value="${product.stock}">
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" id="form-field-1" name="time" value="${product.time}">
              </div>
            </div>
